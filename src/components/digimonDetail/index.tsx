...
import DigimonDetailDto from "../../services/dto/DigimonDetailDto";
import DigimonImage from "../../parts/digimonImage";
import AttributeTypeIcon from "../../parts/typeIcon";
import '../../pages/digimon/index.css'
...
export default function DigimonDetail(props: DetailProps) {

    // @ts-ignore
    let stats = props.data.stats["1"]!
    // @ts-ignore
    let statsLevel50 = props.data.stats["50"]!
    // @ts-ignore
    let statsLevel99 = props.data.stats["99"]!
    return (
        <Container fluid>
            <Row>
                    ...
                    <Table hover size={"sm"}>
                        ...
                        <tr>
                            <td colSpan={2} align={"center"}>
                                <DigimonImage bordered={true} id={props.data.id} variant={'portrait'}
                                              attribute={props.data.attribute} type={props.data.type}/>

                            </td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Name</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.name}</td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Stage</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.stage}</td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Type</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.type}</td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Attribute</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.attribute}</td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Memory</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.memory.toString()}</td>
                        </tr>
                        <tr>
                            <td align={"right"} style={{width: '50%'}}>Slots</td>
                            <td align={"left"} style={{width: '50%'}}> {props.data.slots.toString()}</td>
                        </tr>
                        </tbody>
                    </Table>
                </Col>
                    ...
                    <Card>
                        <Card.Body>
                            <ListGroup className="list-group-flush">
                                <ListGroup.Item>
                                    <strong>Skill: {props.data.skill.name}</strong><br/>
                                    {props.data.skill.description}
                                </ListGroup.Item>
                                <ListGroup.Item>
                                    Hp
                ...
                <Col xs={12}>
                    ...
                    <Table hover responsive>
                        ...
                        <tbody>
                        {
                            props.data.learnAttacks.map(att => {
                                return <tr>
